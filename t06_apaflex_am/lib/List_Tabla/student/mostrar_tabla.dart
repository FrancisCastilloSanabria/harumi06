...
class _StudentState extends State<MaestroStudent> {
  final url =
      Uri.parse("http://192.168.41.18:8085/oraclecloud/v1/students/activate");
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    onChanged: (query) {
                      // Puedes realizar acciones al cambiar el texto si lo necesitas
                      // Por ahora, solo actualiza la apariencia del widget
                      setState(() {});
                    },
                  ),
                ),
      ...
      builder: (context) {
        return Align(
          ...
          child: FractionallySizedBox(
            widthFactor: 0.9,
            heightFactor:
                0.9, // Ajusta según tus necesidades o utiliza un valor fijo
            child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    DropdownButtonFormField<String>(
                      value: document_type_idController.text,
                      onChanged: (newValue) {
                        setState(() {
                          document_type_idController.text = newValue!;
                        });
                      },
                      decoration: InputDecoration(
                    ...
                    TextFormField(
                      ...
                      keyboardType: TextInputType
                          .phone, // Esto establece el teclado para ingresar solo números
                      decoration: InputDecoration(
                        hintText: 'academic_degree_idController',
                        filled: true,
                        enabledBorder: UnderlineInputBorder(
                          borderSide: BorderSide(
                            color: Color.fromARGB(255, 255, 0, 0),
