...
class _StudentInactiveState extends State<StudentInactive> {
  final url =
      Uri.parse("http://192.168.41.18:8085/oraclecloud/v1/students/deactivate");
...
class StudentCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    String documentInfo = '${student.document_type_id}:${student.number_document}';
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: const BorderSide(color: Color.fromARGB(255, 255, 17, 0), width: 2.0),
      ),
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [Color.fromARGB(255, 233, 203, 8), Color.fromARGB(255, 191, 179, 15)],
        ),
      ),
      child: Padding(
                          ...
                          builder: (_) => AlertDialog(
                            ...
                            actions: <Widget>[
                              ...
                              ElevatedButton(
                                style: ButtonStyle(
                                  backgroundColor:
                                      MaterialStateProperty.all(Color.fromARGB(255, 0, 169, 6)),
                                ),
